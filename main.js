...
client.on('guildMemberAdd', member =>{ // ивент, когда пользователь присоединяется к серверу https://discord.js.org/#/docs/main/stable/class/Client?scrollTo=e-guildMemberAdd
    ...
    Ты наш \`${client.guilds.get("https://discord.gg/GNvm7GGZzW").memberCount}\` участник! **`) // айди вашего сервера               !!!!!!!!!!
    .setFooter('Будь всегда на позитиве :3', 'https://cdn.discordapp.com/emojis/59061457610766336.gif?v=1')
...
client.login('d556886679226e5f884cfcabdf82e9b69774aa6f245c8cbc3a8224bdd4da5757') // токен вашего бота
